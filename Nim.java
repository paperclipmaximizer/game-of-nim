...
/** Generates a "avoid removing the last stone" variant of the game of Nim 
 * inits a game with a Player 1, Player 2 and
 * polls for starting stones, plays the gameloop
 */
public class Nim{
	...
	// runs a single turn
	private static Integer turn(Player player, int currentStones, int upperBounds){
